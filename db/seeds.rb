...
Itinerary.create(origin: "St Louis Station", destination: "Beau Bassin Station", price: 38, duration: 12)
Itinerary.create(origin: "St Louis Station", destination: "Vandermeersch Station", price: 38, duration: 18)
Itinerary.create(origin: "St Louis Station", destination: "Rose-Hill Central", price: 38, duration: 21)
Itinerary.create(origin: "St Louis Station", destination: "Belle Rose Station", price: 43, duration: 31)
Itinerary.create(origin: "St Louis Station", destination: "Quatre Bornes Central", price: 43, duration: 33)
...
Itinerary.create(origin: "Coromandel Station", destination: "Beau Bassin Station", price: 38, duration: 10)
Itinerary.create(origin: "Coromandel Station", destination: "Vandermeersch Station", price: 38, duration: 16)
Itinerary.create(origin: "Coromandel Station", destination: "Rose-Hill Central", price: 38, duration: 19)
Itinerary.create(origin: "Coromandel Station", destination: "Belle Rose Station", price: 43, duration: 29)
Itinerary.create(origin: "Coromandel Station", destination: "Quatre Bornes Central", price: 43, duration: 31)
...
Itinerary.create(origin: "Barkly Station", destination: "Belle Rose Station", price: 43, duration: 29)
Itinerary.create(origin: "Barkly Station", destination: "Quatre Bornes Central", price: 43, duration: 31)
Itinerary.create(origin: "Barkly Station", destination: "St Jean Station", price: 43, duration: 31)
Itinerary.create(origin: "Barkly Station", destination: "Trianon Station", price: 43, duration: 59)
Itinerary.create(origin: "Barkly Station", destination: "Phoenix Station", price: 43, duration: 65)
